<template >
 ...
 <div>
   ...
   <div class="form-container">
        <p class="title">Modifier le Projet</p>
        ...
        <form class="form">
          <div class="row mb-3 mt-3 content-group">
            ...
            <div class="col">
              <div class="input-groupe">
                ...
                <MazInput v-model="url"  no-radius color="warning" type="url"/>
              </div>
          ...
          <div class="row mb-3 mt-3 content-group">
            ...
            <div class="col">
              <div class="input-groupe">
                <label for="sous_prefecture">Etat du projet </label>
                <MazSelect v-model="etat" color="warning" :options="EtatOptions" no-radius   /> 
              </div>
              <small v-if="v$.etat.$error">{{ v$.etat.$errors[0].$message }}</small>
            </div>
         ...
         <div class="col">
          <div class="profile-pic">
                ...
                <!-- <img
                  ...
                  width="200"
                /> -->
                <img  :src="selectedActualites.Images" id="output" width="200" />
              </div> 
         </div>       
       </div>
 ...
 <MazDialog v-model="publishDoc" title="Actualites mise à jour  avec success">
   ...
   <template #footer="">
     ...
     <div class="supp" @click="$router.push({ path: '/projets' })" style="background-color: blue; "> Ok</div>
...
methods: {
 ...
 async fetchActualitesDetail() {
        ...
        this.etat = selectedActualites.ProgressDone
        this.url = selectedActualites.ProjectOwner
   ...
   if (this.v$.$errors.length == 0) {
     ...
     const formData = new FormData();
      ...
      if (this.selectedFile === '') {
        ...
        formData.append("ProjectOwner", this.url);
        // formData.append("Photo",  this.selectedActualites.Images);
        formData.append("Publish", this.publish);
        formData.append("ProgressDone", this.etat);

        console.log('formData',this.selectedActualites.Images);
     console.log('rrrr',
       this.titre,
       this.description,
       this.selectedFile
     ...
     try {
       const response = await axios.post(`/projects/update/${this.id}`, formData, {
         headers: {
