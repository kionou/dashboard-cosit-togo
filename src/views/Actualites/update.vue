<template >
 ...
 <div>
   ...
   <div class="form-container">
     <p class="title">Modifier une Actualité</p>
   ...
   if (this.v$.$errors.length == 0) {
     ...
     const formData = new FormData();
      ...
      if (this.selectedFile === '') {
        ...
        formData.append("files[]", this.selectedActualites.images);
     ...
     try {
       const response = await axios.post(`/actualites/${this.id}/update`, formData, {
         headers: {
