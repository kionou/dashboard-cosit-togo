<template >
    ...
    <Loading v-if="loading" style="z-index: 99999;"></Loading>
      ...
      <button class="search-btn"   ><i class="bi bi-search"></i></button>
        ...
        <section class="aplpg-blog-section">
          ...
          <span> Vous n'avez pas encore de role, vous pouvez également en ajouter un !! </span>
        </div>
    ...
    <MazDialog v-model="AddCathegorie" title="Ajouté un role"  >
      ...
      return this.password === this.confirmer_password;
        ...
        async confirmDeletedoc() {
          ...
          try {
            ...
            const response = await axios.delete(`/roles/${this.ToDeleteId}`, {
              headers: {
                Authorization: `Bearer ${this.loggedInUser.token}`,
          ...
          if (this.v$.$errors.length == 0) {
            ...
            try {
              ...
              if (response.data.status === "success") {
               ...
               this.publier = " Votre role a été crée avec succès !"
